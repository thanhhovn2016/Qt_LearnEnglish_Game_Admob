...
id : falsearea10
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr03[9]) > 0){
                playtrueright.play();
...
id : falsearea11
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr03[10]) > 0){
                playtrueright.play();
...
id : falsearea12
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr03[11]) > 0){
                playtrueright.play();
