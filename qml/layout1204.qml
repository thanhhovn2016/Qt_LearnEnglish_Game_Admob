...
import "genrand04.js" as GEN
import "lifeshow.js" as LIFE
Item{
    id:learne03;
    property string qrcsource:'assets:/qml/04/' + wordactionarr04[parseInt(countscreen.text)] + '.jpg';
    property string soundsource:'04/' + wordactionarr04[parseInt(countscreen.text)] + '.mp3';Image{anchors.fill: parent;source:"back.png";}
...
function clicknext(){
    ...
    delay(1, function() {
        ...
        if(parseInt(countscreen.text == 21)){
            ...
            stackView.push({ item: stackView.items04[parseInt(countscreen.text)], destroyOnPop:false })
        }else{
            actionarr04 = GEN.genrandstackview(parseInt(countscreen.text));
            stackView.push({ item: stackView.items04[parseInt(countscreen.text)], destroyOnPop:false })
        }
    });
}
...
id : truearea
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr04[0]) > 0){
                playtrueright.play();
                ...
                if(myscore <= 0){
                    ...
                    stackView.push({ item: stackView.items04[0], destroyOnPop:false })
                }else{
                    playfalsewrong.play();
                }
...
id : falsearea
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr04[1]) > 0){
                playtrueright.play();
...
id : falsearea01
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr04[2]) > 0){
                playtrueright.play();
...
id : falsearea04
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr04[3]) > 0){
                playtrueright.play();
...
id : falsearea05
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr04[4]) > 0){
                playtrueright.play();
...
id : falsearea06
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr04[5]) > 0){
                playtrueright.play();
...
id : falsearea07
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr04[6]) > 0){
                playtrueright.play();
...
id : falsearea08
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr04[7]) > 0){
                playtrueright.play();
...
id : falsearea09
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr04[8]) > 0){
                playtrueright.play();
...
id : falsearea10
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr04[9]) > 0){
                playtrueright.play();
...
id : falsearea11
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr04[10]) > 0){
                playtrueright.play();
...
id : falsearea12
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr04[11]) > 0){
                playtrueright.play();
...
Text{
    ...
    text:wordactionarr04[parseInt(countscreen.text)];
}
