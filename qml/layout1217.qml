...
import "genrand17.js" as GEN
import "lifeshow.js" as LIFE
Item{
    id:learne03;
    property string qrcsource:'assets:/qml/17/' + wordactionarr17[parseInt(countscreen.text)] + '.jpg';
    property string soundsource:'17/' + wordactionarr17[parseInt(countscreen.text)] + '.mp3';Image{anchors.fill: parent;source:"back.png";}
...
function clicknext(){
    ...
    delay(1, function() {
        ...
        if(parseInt(countscreen.text == 21)){
            ...
            stackView.push({ item: stackView.items17[parseInt(countscreen.text)], destroyOnPop:false })
        }else{
            actionarr17 = GEN.genrandstackview(parseInt(countscreen.text));
            stackView.push({ item: stackView.items17[parseInt(countscreen.text)], destroyOnPop:false })
        }
    });
}
...
id : truearea
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr17[0]) > 0){
                playtrueright.play();
                ...
                if(myscore <= 0){
                    ...
                    stackView.push({ item: stackView.items17[0], destroyOnPop:false })
                }else{
                    playfalsewrong.play();
                }
...
id : falsearea
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr17[1]) > 0){
                playtrueright.play();
...
id : falsearea01
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr17[2]) > 0){
                playtrueright.play();
...
id : falsearea04
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr17[3]) > 0){
                playtrueright.play();
...
id : falsearea05
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr17[4]) > 0){
                playtrueright.play();
...
id : falsearea06
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr17[5]) > 0){
                playtrueright.play();
...
id : falsearea07
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr17[6]) > 0){
                playtrueright.play();
...
id : falsearea08
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr17[7]) > 0){
                playtrueright.play();
...
id : falsearea09
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr17[8]) > 0){
                playtrueright.play();
...
id : falsearea10
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr17[9]) > 0){
                playtrueright.play();
...
id : falsearea11
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr17[10]) > 0){
                playtrueright.play();
...
id : falsearea12
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr17[11]) > 0){
                playtrueright.play();
...
Text{
    ...
    text:wordactionarr17[parseInt(countscreen.text)];
}
