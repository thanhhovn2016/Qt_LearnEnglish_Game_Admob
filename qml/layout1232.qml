...
import "genrand32.js" as GEN
import "lifeshow.js" as LIFE
Item{
    id:learne03;
    property string qrcsource:'assets:/qml/32/' + wordactionarr32[parseInt(countscreen.text)] + '.jpg';
    property string soundsource:'32/' + wordactionarr32[parseInt(countscreen.text)] + '.mp3';Image{anchors.fill: parent;source:"back.png";}
...
function clicknext(){
    ...
    delay(1, function() {
        ...
        if(parseInt(countscreen.text == 21)){
            ...
            stackView.push({ item: stackView.items32[parseInt(countscreen.text)], destroyOnPop:false })
        }else{
            actionarr32 = GEN.genrandstackview(parseInt(countscreen.text));
            stackView.push({ item: stackView.items32[parseInt(countscreen.text)], destroyOnPop:false })
        }
    });
}
...
id : truearea
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr32[0]) > 0){
                playtrueright.play();
                ...
                if(myscore <= 0){
                    ...
                    stackView.push({ item: stackView.items32[0], destroyOnPop:false })
                }else{
                    playfalsewrong.play();
                }
...
id : falsearea
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr32[1]) > 0){
                playtrueright.play();
...
id : falsearea01
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr32[2]) > 0){
                playtrueright.play();
...
id : falsearea04
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr32[3]) > 0){
                playtrueright.play();
...
id : falsearea05
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr32[4]) > 0){
                playtrueright.play();
...
id : falsearea06
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr32[5]) > 0){
                playtrueright.play();
...
id : falsearea07
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr32[6]) > 0){
                playtrueright.play();
...
id : falsearea08
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr32[7]) > 0){
                playtrueright.play();
...
id : falsearea09
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr32[8]) > 0){
                playtrueright.play();
...
id : falsearea10
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr32[9]) > 0){
                playtrueright.play();
...
id : falsearea11
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr32[10]) > 0){
                playtrueright.play();
...
id : falsearea12
        ...
        onClicked: {
            ...
            if(qrcsource.indexOf(actionarr32[11]) > 0){
                playtrueright.play();
...
Text{
    ...
    text:wordactionarr32[parseInt(countscreen.text)];
}
