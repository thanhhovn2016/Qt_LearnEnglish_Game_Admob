...
Item{
    id:learne03;
    property string qrcsource:'assets:/qml/media01/05/' + wordactionarr05[parseInt(countscreen.text)] + '.jpg';
    property string soundsource:'media01/05/' + wordactionarr05[parseInt(countscreen.text)] + '.mp3';Image{anchors.fill: parent;source:"back.png";}
...
id : truearea
        Rectangle {
            ...
            Image {
                ...
                height:heightimg6;
                anchors.fill: parent;
                source: 'media01/05/'+actionarr05[0]+'.jpg'
            }
...
id : falsearea
        Rectangle {
            ...
            Image {
                ...
                anchors.fill: parent;
                source: "media01/05/"+actionarr05[1]+".jpg";
            }
            Rectangle { // rounded corners for img
...
id : falsearea01
        Rectangle {
            ...
            Image {
                ...
                anchors.fill: parent;
                source: "media01/05/"+actionarr05[2]+".jpg"
            }
            Rectangle { // rounded corners for img
...
id : falsearea04
        Rectangle {
            ...
            Image {
                ...
                anchors.fill: parent;
                source: "media01/05/"+actionarr05[3]+".jpg"
            }
            Rectangle { // rounded corners for img
...
id : falsearea05
        Rectangle {
            ...
            Image {
                ...
                anchors.fill: parent;
                source: "media01/05/"+actionarr05[4]+".jpg"
            }
            Rectangle { // rounded corners for img
...
id : falsearea06
        Rectangle {
            ...
            Image {
                ...
                height:heightimg6;
                anchors.fill: parent;
                source: "media01/05/"+actionarr05[5]+".jpg"
            }
            Rectangle { // rounded corners for img
